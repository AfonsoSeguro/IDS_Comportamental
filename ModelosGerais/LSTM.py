...
inp_train,inp_test,out_train,out_test = train_test_split(np.array(inp), np.array(out), test_size=0.2)
...
model = keras.Sequential([
    keras.layers.Input(shape = (10,18)),
...
train = model.fit(x = inp_train, y = out_train, epochs = 10, validation_split = 0.1, verbose = 1)
